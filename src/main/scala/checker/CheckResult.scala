...
//    case SuccessResult(_, _, _) => "success"
//    case FailResult(_, _, _, _) => "fail"
//  }
//}
//
//// History logs
//case class ProjectHistory[E <: HistoryEntry](history: Map[ACheck, Seq[E]], maxSize: Option[Int] = None)
//case class AbsoluteHistory[E <: HistoryEntry](project: Map[Project, ProjectHistory[E]], maxSize: Option[Int] = None)
//
...
////final case class HostRegistry(hosts: Map[Id, AHost]) {
////  def checkRegistry: CheckRegistry = ???
////
////  def join(host: AHost): HostRegistry =
////    copy(hosts = hosts.+((host.id, host)))
////}
////
